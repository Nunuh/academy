/*! Select2 4.0.6-rc.0 | https://github.com/select2/select2/blob/master/LICENSE.md */ !(function (
    ...
    var b = (function () {
            ...
            return (
                ...
                b.define("select2/results", ["jquery", "./utils"], function (
                    a,
                    b
                ) {
                    function c(a, b, d) {
                    ...
                    function (a, b, c) {
                        ...
                        return (
                            (d.prototype.render = function (b) {
                                var c = a(
                                    '<li class="select2-search select2-search--inline"><input class="select2-search__field" type="search" tabindex="-1" autocomplete="off" autocorrect="off" autocapitalize="none" spellcheck="false" role="textbox" aria-autocomplete="list" style="width:100%" /></li>'
                                );
                ...
                b.define("select2/selection/eventRelay", ["jquery"], function (
                    a
                ) {
                    function b() {}
                    return (
                ...
                b.define("select2/dropdown", ["jquery", "./utils"], function (
                    a,
                    b
                ) {
                    function c(a, b) {
                        ...
                        return (
                            ...
                            (e.prototype._registerDomEvents = function () {
                                ...
                                this.$element.on("change.select2", function () {
                                    ...
                                    this.$element.on("focus.select2", function (
                                        a
                                    ) {
                                        b.trigger("focus", a);
                                    }),
                                ...
                                this.on("open", function () {
                                    ...
                                    this.on("query", function (b) {
                                        a.isOpen() || a.trigger("open", {}),
                                            this.dataAdapter.query(b, function (
                                                c
                                            ) {
