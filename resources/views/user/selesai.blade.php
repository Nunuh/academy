<?PHP
header ("refresh:3;url=/academy/public/");
?>
                ...
                <div class="register-form">
                    ...
                    <div id="progressbar">
                        <ul class="nav" id="myTab">
                            <li class="active"><a role="tab" aria-controls="otp" title="Konfirmasi OTP"><i class='bx bx-user'></i>Verifikasi No. Hp</a> </li>
                            <li class="active"><a role="tab" aria-controls="isi" title="Email dan Password"><i class='bx bx-photo-album'></i>Email dan Password</a> </li>
                            <li class="active"><a role="tab" aria-controls="selesai" title="Registrasi Berhasil"><i class='bx bx-check-square'></i>Registrasi Berhasil</a></li>
                        </ul>
                    </div>
                    <div id="msform" class="tab-content">
                        <div id="selesai" class="tab-pane fade-in active" role="tabpanel">
                            <fieldset>
                                <img src="{{ asset('img/welcome.jpg')}}" style="height:200px;">
                                <br>
